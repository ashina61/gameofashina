...
const ASSETS = ['/', '/manifest.webmanifest', '/icon-192.png', '/icon-512.png', '/images/game/environments/sahilhisar-town-v2.webp', ...['divan', 'konut', 'kereste', 'tas', 'ambar', 'medrese', 'saray', 'elcilik', 'hamam', 'carsi', 'kisla', 'liman', 'tersane'].map(name => `/images/game/${name}.webp`)]
