...
export default function GameShell() {
  ...
  return <main className="game-shell">
    ...
    {game ? <><ResourceBar game={game} onSelect={() => openPanel('economy')} /><AdvisorBar game={game} active={panel} onSelect={openPanel} /><div className="game-body"><div className="city-column"><CityScene game={game} placing={buildMode || plot !== null} onBuilding={openBuilding} onPlot={openPlot} onExitBuild={() => setBuildMode(false)} onOpenList={() => openPanel('build')} /></div></div></> : <div className="game-loading"><img src={buildingImage('divan')} alt="" width={150} height={150} /><h1>Şehrin uyanıyor…</h1><p>Sahilhisar kapılarını açıyor.</p></div>}
