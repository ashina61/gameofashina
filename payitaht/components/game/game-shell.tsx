...
export default function GameShell() {
  ...
  function panelHero(): string | null | undefined {
    ...
    const map: Partial<Record<Exclude<Panel, null>, string>> = {
      research: buildingImage('medrese', Math.max(1, game.buildings.medrese)), army: buildingImage('kisla', Math.max(1, game.buildings.kisla)),
      cities: buildingImage('saray', Math.max(1, game.buildings.saray || 3)), people: buildingImage('konut', Math.max(1, game.buildings.konut)),
      diplomacy: buildingImage('elcilik', Math.max(1, game.buildings.elcilik || 3)), objectives: buildingImage('divan', Math.max(1, game.buildings.divan)),
