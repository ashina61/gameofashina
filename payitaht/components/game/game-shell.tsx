...
export default function GameShell() {
  const { game, empire, command, selectCity, colonize, sendCargo, spy, raid, piracy, warning, reset } = useGame()
